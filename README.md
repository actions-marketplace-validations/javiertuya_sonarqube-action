...
- `restore-artifact-name<N>`, Where `<N>` is a number (1 to 8). Optional name of an artifact to be restored to send additional info to SonarQube (e.g. coverage reports)
